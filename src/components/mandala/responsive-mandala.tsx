...
import { MandalaView } from './mandala-view';
import { computeProgress } from '@/lib/progress';
import { isInheritedBlocked } from '@/lib/blocking';
import { useRouter } from 'next/navigation';

interface ResponsiveMandalaProps {
  treeId: string;
  canvasId: string;
  nodes: Node[];
  rootNode: Node | null;
...
export function ResponsiveMandala({ treeId, canvasId, nodes, rootNode }: ResponsiveMandalaProps) {
